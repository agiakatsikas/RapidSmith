...
public class FaultInjectionNumberedHighlightedTile  extends QGraphicsRectItem{
	/** */
	protected QGraphicsTextItem text;
	/** */
	protected FaultInjectionTileScene scene;
	/** */
	...
	public FaultInjectionNumberedHighlightedTile(Tile t, FaultInjectionTileScene scene, int number){

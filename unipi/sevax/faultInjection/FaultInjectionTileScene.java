 ...
 * @author Chris Lavin
 */
public class FaultInjectionTileScene extends QGraphicsScene{
	 ...
	 * Empty constructor
	 */
	public FaultInjectionTileScene(){
		setDesign(null);
	 ...
	 */
	public FaultInjectionTileScene(Design design, boolean hideTiles, boolean drawPrimitives){
		setDesign(design);
	 ...
	 * @param drawPrimitives A flag to draw boxes to represent primitives. 
	 */
	public FaultInjectionTileScene(Device device, boolean hideTiles, boolean drawPrimitives, String workingDirectory, boolean ebd, boolean seuAnalysis){

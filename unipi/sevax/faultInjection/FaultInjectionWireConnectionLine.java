 ...
 */
public class FaultInjectionWireConnectionLine extends QGraphicsLineItem{
	...
	private FaultInjectionTileScene scene;
	/** The current tile */
	private Tile tile;
	/** The current wire */
	private int wire;
	 ...
	 * @param wire The wire.
	 */
	public FaultInjectionWireConnectionLine(double x1, double y1, double x2, double y2, 
			FaultInjectionTileScene scene, Tile tile, int wire){
		super(x1, y1, x2, y2);
		this.scene = scene;
		this.tile = tile;
		this.wire = wire;
	...
	public void mousePressEvent(QGraphicsSceneMouseEvent event){
		if(scene.getClass().equals(FaultInjectionDeviceBrowserScene.class)){
			((FaultInjectionDeviceBrowserScene)scene).drawConnectingWires(tile, wire);			
		}
	}
	 ...
	 * @return the scene
	 */
	public FaultInjectionTileScene getScene() {
		return scene;
	}
	 ...
	 */
	public void setScene(FaultInjectionTileScene scene) {
		this.scene = scene;
	}
}

 ...
 */
public class SensitiveWireConnectionLine extends QGraphicsLineItem{
	...
	private SensitiveTileScene scene;
	/** The current tile */
	private Tile tile;
	/** The current wire */
	private int wire;
	 ...
	 * @param wire The wire.
	 */
	public SensitiveWireConnectionLine(double x1, double y1, double x2, double y2, 
			SensitiveTileScene scene, Tile tile, int wire){
		super(x1, y1, x2, y2);
		this.scene = scene;
		this.tile = tile;
		this.wire = wire;
	...
	public void mousePressEvent(QGraphicsSceneMouseEvent event){
		if(scene.getClass().equals(SensitiveDeviceBrowserScene.class)){
			((SensitiveDeviceBrowserScene)scene).drawConnectingWires(tile, wire);			
		}
	}
	 ...
	 * @return the scene
	 */
	public SensitiveTileScene getScene() {
		return scene;
	}
	 ...
	 */
	public void setScene(SensitiveTileScene scene) {
		this.scene = scene;
	}
}

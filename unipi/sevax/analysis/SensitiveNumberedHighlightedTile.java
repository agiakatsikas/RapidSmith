...
public class SensitiveNumberedHighlightedTile  extends QGraphicsRectItem{
	/** */
	protected QGraphicsTextItem text;
	/** */
	protected SensitiveTileScene scene;
	/** */
	...
	public SensitiveNumberedHighlightedTile(Tile t, SensitiveTileScene scene, int number){

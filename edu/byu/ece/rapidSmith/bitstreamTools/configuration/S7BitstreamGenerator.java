...
public class S7BitstreamGenerator extends BitstreamGenerator {

public static int S7_ENDING_FAR = 0x00EF8000;
    
    private static S7BitstreamGenerator _singleton = null;
    
    private S7BitstreamGenerator() {
        
    }
    
    public static S7BitstreamGenerator getSharedInstance() {
        if (_singleton == null) {
            _singleton = new S7BitstreamGenerator();
        }
        return _singleton;
    }
